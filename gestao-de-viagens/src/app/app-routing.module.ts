...
import { UpdateLocalPage } from './update-local/update-local.page';
...
const routes: Routes = [
  ...
  { path: 'update-local/:id', component: UpdateLocalPage },
  ...
  {
    path: 'update-local',
    loadChildren: () => import('./update-local/update-local.module').then( m => m.UpdateLocalPageModule)
  },
];
